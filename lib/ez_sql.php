<?php
    ...
    //define("EZSQL_DB_USER",     "twishlist");            // <-- mysql db user
    //define("EZSQL_DB_PASSWORD", "twishlist");     // <-- mysql db password
    //define("EZSQL_DB_NAME",     "twishlist");        // <-- mysql db pname
    ...
    class db {
        ...
        function query($query)
        {
            ...
            // add query to the debug query string
            $this->debug_queries .= "<p>" . $query . "</p>";            
